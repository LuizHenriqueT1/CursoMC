...
public class DBService {
    ...
    public void instanciaDB() throws ParseException {
        ...
        cli1.getTelefones().addAll(Arrays.asList("27363323", "938329609"));

        Cliente cli2 = new Cliente(null, "Ana Rosa", "anarosa@gmail.com", "16196401041", TipoCliente.PESSOAFISICA, passwordEncoder.encode("12345678"));
        cli1.getTelefones().addAll(Arrays.asList("97363321", "934829608"));
        cli2.addPerfil(Perfil.ADMIN);

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "37227734", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Floriano", "210", null, "Centro", "01579589", cli2, c2);
